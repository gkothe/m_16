							...
							<ul class="nav side-menu">
								...
								<li><a class="clickmenu2"><i class="fa fa-gear clickmenu2"></i> Parâmetros <span
									...
									<ul class="nav child_menu">
										...
										<li><a linkmenu="wizardhorarios" onMouseup="trocaPag(this,'N',event);" class="clickmenu">Configurações
												de horários</a></li>
									...
									<tr>
										...
										<td align="right" class="table_header">
											...
											<div style="cursor: pointer; display: none;" id="msg_holder2">
												<a><span class="label label-warning aviso_pedido" id="msg_offline" style="font-size: 195%;">O
														servidor TragoAqui está offline! </span></a>
											</div>
										</td>
									</tr>
								</table>
